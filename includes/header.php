...
$roleModules = [
    'admin' => [
        ...
        ['modules/accounts/expenses.php', 'fas fa-file-invoice-dollar', 'Accounts Expenses'],
        ['modules/accounts/reports.php', 'fas fa-chart-column', 'Accounts Reports'],
        ['modules/accounts/ledger.php', 'fas fa-book', 'Ledger'],
        ['modules/accounts/balance-sheet.php', 'fas fa-scale-balanced', 'Balance Sheet'],
        ...
        ['modules/hr/attendance.php', 'fas fa-user-check', 'HR Attendance'],
        ['modules/hr/leave.php', 'fas fa-calendar-minus', 'HR Leave'],
        ['modules/hr/payroll.php', 'fas fa-money-check-dollar', 'HR Payroll'],
        ['modules/library/index.php', 'fas fa-book', 'Library'],
        ['modules/library/issue.php', 'fas fa-book-open-reader', 'Library Issue'],
        ['modules/library/return.php', 'fas fa-rotate-left', 'Library Return'],
        ['modules/library/fines.php', 'fas fa-coins', 'Library Fines'],
        ...
        ['modules/homework/index.php', 'fas fa-book-open', 'Homework / Diary'],
        ...
        ['modules/internal/index.php', 'fas fa-briefcase', 'Internal Management'],
    ...
    'teacher' => [
        ...
        ['modules/downloads/index.php', 'fas fa-download', 'Downloads'],
        ['modules/ptm/index.php', 'fas fa-users', 'PTM'],
        ['modules/tasks/index.php', 'fas fa-tasks', 'My Tasks'],
        ['modules/complaints/index.php', 'fas fa-exclamation-circle', 'Complaints'],
        ['modules/internal/index.php', 'fas fa-briefcase', 'Internal Management'],
    ],
    'staff' => [
    ...
    'student' => [
        ...
        ['modules/homework/index.php', 'fas fa-book-open', 'My Homework'],
        ['modules/lms/index.php', 'fas fa-book-reader', 'My LMS Material'],
        ['modules/timetable/index.php', 'fas fa-clock', 'My Timetable'],
        ['modules/downloads/index.php', 'fas fa-download', 'Downloads'],
        ['modules/ptm/index.php', 'fas fa-users', 'PTM Notices'],
    ...
    'parent' => [
        ['modules/student_profile/index.php', 'fas fa-id-card', 'Student Profile'],
        ['modules/homework/index.php', 'fas fa-book-open', 'Homework / Diary'],
        ['modules/lms/index.php', 'fas fa-book-reader', 'LMS Material'],
        ['modules/timetable/index.php', 'fas fa-clock', 'Timetable'],
        ['modules/downloads/index.php', 'fas fa-download', 'Downloads'],
        ['modules/ptm/index.php', 'fas fa-users', 'PTM Notices'],
        ['modules/fee_management/index.php', 'fas fa-money-bill-wave', 'Fee Status'],
        ['modules/complaints/index.php', 'fas fa-exclamation-circle', 'Complaints'],
    ],
];

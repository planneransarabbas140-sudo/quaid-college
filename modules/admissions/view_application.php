...
<div class="row mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <button type="button" onclick="window.print()" class="btn btn-light rounded-pill px-4"><i class="fas fa-print me-1"></i> Print</button>
...
<div class="card border-0 shadow-sm rounded-4 mb-4">
    <div class="card-body p-4">
        <div class="application-detail-grid">
            <div><small class="text-muted">Student Name</small><div class="fw-bold"><?= app_h($app['full_name']) ?></div></div>
            <div><small class="text-muted">Father Name</small><div class="fw-bold"><?= app_h($app['father_name']) ?></div></div>
            <div><small class="text-muted">CNIC / B-Form</small><div class="fw-bold"><?= app_h($app['cnic']) ?></div></div>
            <div><small class="text-muted">Program</small><div class="fw-bold"><?= app_h($app['program']) ?></div></div>
            <div><small class="text-muted">Campus</small><div class="fw-bold"><?= app_h($app['campus']) ?></div></div>
            <div><small class="text-muted">Session</small><div class="fw-bold"><?= app_h($app['session']) ?></div></div>
            <div><small class="text-muted">Phone</small><div class="fw-bold"><?= app_h($app['phone']) ?></div></div>
            <div><small class="text-muted">WhatsApp</small><div class="fw-bold"><?= app_h($app['whatsapp']) ?></div></div>
            <div><small class="text-muted">Email</small><div class="fw-bold"><?= app_h($app['email']) ?></div></div>
            <div><small class="text-muted">Address</small><div class="fw-bold"><?= app_h($app['address']) ?></div></div>
        </div>
    </div>
</div>

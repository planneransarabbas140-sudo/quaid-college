(function(){
  ...
  ready(function(){
    ...
    if(collapsed&&window.innerWidth>768){sidebar.classList.add('active');content&&content.classList.add('active');}
    toggle.addEventListener('click',function(){
      if(window.innerWidth<=768){sidebar.classList.toggle('active');backdrop&&backdrop.classList.toggle('visible',sidebar.classList.contains('active'));return;}
